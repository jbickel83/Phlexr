...
export const accountPages = {
  ...
  refer: {
    ...
    eyebrow: "PHLEXR Growth",
    intro:
      "Invite someone to PHLEXR. When they sign up successfully through your referral, you get 5 free boosts added to your account.",
    cards: [
      {
        title: "Share your referral link",
        body:
          "PHLEXR is being prepared for referral links that make it easy to invite friends from your profile, feed, and share surfaces without leaving the app.",
      },
      {
        title: "Copy a code or link",
        body:
          "Your referral tools are being structured so you can quickly copy a code or personal invite link and drop it into messages, posts, or private conversations.",
      },
      {
        title: "Email invites and pending status",
        body:
          "PHLEXR is also being set up for direct email invites, plus a clean pending-status view so you can track who has been invited and who has joined.",
      },
    ],
    sections: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            value: "Granted after a successful referred signup",
          },
        ],
      },
      {
        ...
        items: [
          {
            label: "Referral link",
            value: "Share-ready structure in place for a personal invite URL",
          },
          {
            label: "Copy code or link",
            value: "Prepared for quick copy actions from mobile and desktop",
          },
          {
            label: "Email invite",
            value: "Invite entry point reserved for future email-based referrals",
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            value: "No successful referrals yet",
          },
          {
            label: "Pending invites",
            value: "No pending invites yet",
          },
          {
            label: "Boosts earned",
            value: "0 boosts earned from referrals",
          },
        ],
      },
    ],
